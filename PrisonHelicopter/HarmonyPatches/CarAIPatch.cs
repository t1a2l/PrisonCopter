...
namespace PrisonHelicopter.HarmonyPatches {
    ...
    public static class CarAIPatch {
        ...
        private delegate bool StartPathFindPoliceCarAIDelegate(ushort vehicleID, ref Vehicle vehicleData);
        ...
        public static bool PathfindFailure(ushort vehicleID, ref Vehicle data)
	{
            ...
            if(vehicle.Info.GetAI() is PoliceCarAI &&  vehicle.Info.GetClassLevel() >= ItemClass.Level.Level4) is_prison_van = true;
            ...
            if(is_prison_van && (data.m_flags & Vehicle.Flags.GoingBack) == 0 && (is_prison || is_big_police_station))
            {
                ...
                if(!StartPathFindPoliceCarAI(vehicleID, ref data))
                {
