namespace PrisonHelicopter.PrisonHelicopter
{
    ...
    public static class UIUtil
    {
        ...
        {
            return CreateSprite("PoliceCopterButton", null, offset,
                parentComponent, handler);
        }

        private static UISprite CreateSprite(string buttonName, string tooltip, Vector3 offset,
